...
/**
 * This class is a source copy of {@link java.util.ArrayDeque}, but with the addition 
 * of the {@link #get(int)} and {@link #set(int, Object)} methods for constant time random access.
 */
@SuppressWarnings("unchecked")
public class ArrayListDeque<E> extends AbstractCollection<E>
                           implements Deque<E>, Cloneable, Serializable, RandomAccess
{
     ...
     */
    public ArrayListDeque(int numElements) {
     ...
     */
    @Override
	public ArrayListDeque<E> clone() {
        try {
            ArrayListDeque<E> result = (ArrayListDeque<E>) super.clone();
