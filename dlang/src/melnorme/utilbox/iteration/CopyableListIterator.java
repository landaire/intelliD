...
/**
 * A simple no-modification list iterator that implements the {@link melnorme.utilbox.iteration.ICopyableIterator} API.
 * Will likely exhibit bad performance if underlying list is not {@link java.util.RandomAccess}.
 */
