...
import dtool.ast.definitions.*;
import dtool.ast.definitions.DefUnit.ProtoDefSymbol;
import dtool.ast.expressions.*;
...
import static melnorme.utilbox.core.Assert.AssertNamespace.*;
...
public abstract class DeeParser_RefOrExp extends DeeParser_Common {
	...
	/** Note: consider interaction with {@link #determineTypeModifier(dtool.parser.DeeTokens)} */
 ...
 * this is to ensure that the parser state is restored properly when {@link DeeParser_RefOrExp.ParseRule_Expression} is done.
 */
