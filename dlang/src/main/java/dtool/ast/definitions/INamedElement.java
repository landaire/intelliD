 ...
 * Implementation may be an AST node such as {@link dtool.ast.definitions.DefUnit} (that is the more common case).
 */
public interface INamedElement extends IDefElement {
	 ...
	 * but this method allows proxy {@link INamedElement} classes to resolve to their proxied {@link dtool.ast.definitions.DefUnit}.
