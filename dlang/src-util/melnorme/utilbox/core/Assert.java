...
public class Assert {
	 ...
	 * Default handler behavior is to throw an {@link melnorme.utilbox.core.Assert.AssertFailedException} with given message.
	 */
	public static void isTrue(boolean condition, String message) {
		checkAssertion(condition, message);
	}
	/** Like {@link melnorme.utilbox.core.Assert#isTrue(boolean, String)} with no message */
	...
	/** Like {@link melnorme.utilbox.core.Assert#isNotNull(Object, String)} with no message. */
	...
	/** Like {@link melnorme.utilbox.core.Assert#fail(String)} with no message. */
	...
	/** Like {@link melnorme.utilbox.core.Assert#fail(String)}, but specifically signals unreachable code */
