...
public class ArrayUtil {
	...
	/** Same as {@link java.util.Arrays#copyOfRange(Object[], int, int)} */
	public static <T> T[] copyOfRange(T[] original, int from, int to) {
        return Arrays.copyOfRange(original, from, to);
    }
	
	/** Same as {@link java.util.Arrays#copyOfRange(Object[], int, int, Class)} */
	...
	/** @return the same as {@link java.util.List#indexOf(Object)}, using given array as a collection. */
	...
	/** Is {@link #map(Object[], melnorme.utilbox.core.fntypes.Function, Class)}  with klass = Object.class */
